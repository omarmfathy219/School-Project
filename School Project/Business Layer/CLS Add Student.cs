...
namespace School_Project.Business_Layer
{
    class CLS_Add_Student
    {
        ...
        public void Update_Student(int ID, string FIRST_NAME, string LAST_NAME, string BIRTH_DATE, string CLASS, string ACADEMIC_YEAR, string PHONE_NUMBER, string CITY, string STUDENT_SUPERVISOR, string STUDY_FEES)
        {
            ...
            Data_Access_Layer.ExecuteCommand("Update_Student", param);
            Data_Access_Layer.Clsoe();
        }
    }
}
